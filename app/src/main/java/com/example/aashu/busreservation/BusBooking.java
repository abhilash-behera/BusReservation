...
public class BusBooking extends AppCompatActivity {
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pos !=0) {
                    ...
                    Toast.makeText(BusBooking.this,radioSexButton.getText(), Toast.LENGTH_SHORT).show();
                    if (checkValidation()) {
                        t = new Thread() {
                            public void run() {
                                postdetail();
    ...
    public void postdetail() {
       ...
       // Toast.makeText(BusBooking.this, date.toString(), Toast.LENGTH_SHORT).show();
        final String result = obj.get_httpvalue("http://"+IP+"/bus/usar_details.php", l1, getApplicationContext());
        JSONArray jArray;
        try {
