...
public class SearchBus extends AppCompatActivity {
    ...
    ArrayList<SearchResults> resultss = new ArrayList<SearchResults>();
    ...
    final String result = obj.get_httpvalue("http://"+BusBooking.IP+"/bus/route.php", l1, getApplicationContext());
